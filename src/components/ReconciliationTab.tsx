      ...
      {!hasProcessed ? (
        <Card className="p-6 border-primary/30 bg-secondary/10">
          ...
          <ol className="list-decimal list-inside text-sm text-muted-foreground space-y-1 mb-4">
            <li>Abre la página web de tu banco (Banesco, Mercantil, BDV, etc.).</li><li>Sombrea y copia (Ctrl+C) las filas de los movimientos / abonos del día.</li><li>Pega (Ctrl+V) el texto aquí abajo y el sistema extraerá las referencias y los montos.</li>
          </ol>
          {/* 👈 TEXTAREA SEGURO Y NATIVO */}
          <textarea 
